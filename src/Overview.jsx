...
function Overview() {
  return (
    <div className="md:flex md:flex-col xl:flex-row mt-8  w-full  gap-4 hidden">
      <div className="overview-container xl:w-[694px] xl:h-[226px]  p-6 text-white rounded-2xl  pb-8">
        ...
        <div className="flex mt-12 gap-8">
          ...
          <span>
            <p>Funds in Escrow</p>
            <p className="lg:text-2xl text-xl">$62,231</p>
          </span>
          <span>
      ...
      <div className="border border-black rounded-2xl w-[340px] xl:h-[226px] p-6 hidden xl:flex xl:flex-col">
        ...
        <div className="mt-4 flex items-center justify-between">
          <div className="flex gap-2 items-center">
            ...
            <div className="">
              ...
              <div className="flex rounded-lg  bg-[#B4DFFF]  text-sm w-[190px] mb-[10px]">
                <div className="bg-[#0D98FE] w-[50px] p-[2px] rounded-tr-lg rounded-br-lg" />
              </div>
            </div>
          </div>
